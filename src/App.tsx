...
function App() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      const totalAutoGeneratedDirt = (autoClickPower + endermanPower) * allayMultiplier;
  ...
  }, [autoClickerCount, friendlyEndermanCount, allayCount, increaseDirtCount, blockPosition, activeTab]);
  ...
  const endermanPower = friendlyEndermanCount * 5;
  const allayMultiplier = allayCount > 0 ? 1 + (allayCount * 0.2) : 1;
  const totalDirtPerSecond = (totalAutoClickPower + endermanPower) * allayMultiplier;
